...
\usepackage[left=20mm, right=20mm, top=20mm, bottom=15mm, includefoot]{geometry}
...
\usepackage{url}
\usepackage{seqsplit}
\hyphenation{imple-men-ta-tion com-plex-ities com-plex-ity pre-fe-ren-tial cor-re-la-tion}
